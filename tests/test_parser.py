...
SHOWS = [
    ...
    ("The.Grand.Tour.S03E04.720p.WEB.H264-METCON[eztv].mkv", ("the grand tour", 3, 4)),
    (
    ...
    ("S.W.A.T.2017.S06E11.HDTV.x264-PHOENiX.avi", ("s w a t", 6, 11)),
    (
        "The Last Of Us (2023) S01E02 (1080p AMZN WEB-DL x265 HEVC 10bit DDP 5.1 Vyndros).avi",
        ("the last of us", 1, 2),
    ),
    ("AEW Dynamite 2023 01 25 720p WEB h264-HEEL [TJET].avi", ("aew dynamite", 1, 25)),
    ("DexterS01E03.1080p.AMZN.WEB-DL.x265.avi", ("dexter", 1, 3)),
    (
        "the.witcher.us.s01e04.internal.web.x264-strife[eztv].mkv",
        ("the witcher us", 1, 4),
    ),
    ("North.and.South.E04 +C.srt", ("north and south", 1, 4)),
    ("North.and.South.E03.mkv", ("north and south", 1, 3)),
    (
    ...
    ("IT Crowd/Season 2/05-Smoke and Mirrors.avi", ("it crowd", 2, 5)),
    (
        "IT Crowd/Season 4/The_IT_Crowd.4x06.Reynholm_V_Reynholm.REPACK.WS_PDTV_Xv-iD.[VTV].avi",
        ("it crowd", 4, 6),
    ),
    ("Better Call Saul S02 03.mkv", ("better call saul", 2, 3)),
    ("Archer S05E10 - Palace Intrigue Part I.m4v", ("archer", 5, 10)),
    ("House - [1x02] - Paternity.mkv", ("house", 1, 2)),
]
...
MOVIES = [
    ...
    ("Legally.Exposed.1997-DVDRip.avi", ("legally exposed", 1997, [])),
    ("Resurrection 2022 BluRay 1080p.mp4", ("resurrection", 2022, ["1080p", "BD"])),
    (
...
@pytest.mark.parametrize(
    "series_title, result", [("the grand tour", "grand tour, The")]
)
